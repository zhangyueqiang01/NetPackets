...
def main():
    ...
    parser.add_argument("-u", action="store_true", help="Print UDP header format")
    parser.add_argument("-t", action="store_true", help="Print TCP header format")
    parser.add_argument("-I", action="store_true", help="Print IPV4 header format")
    parser.add_argument("-i", action="store_true", help="Print ICMP header format")
